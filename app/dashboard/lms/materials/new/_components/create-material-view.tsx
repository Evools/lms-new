...
- **Определение:** Главная мысль и предмет изучения темы.
- **Принцип работы:** Как функционирует механизм и где применяется.

> **[IMPORTANT]** Понимание этого принципа критически важно для выполнения курсовых и практических заданий.

### 2. Практический пример
\`\`\`typescript
// Иллюстративный пример реализации
interface ServiceConfig {
  apiUrl: string;
  timeoutMs: number;
}

export function initializeService(config: ServiceConfig) {
  console.log("Сервис запущен с параметрами:", config);
}
\`\`\`
...
| :--- | :--- | :--- |
| **Интерфейс** | Контракт взаимодействия | Архитектура кода |
| **Хук** | Функция состояния | Компоненты UI |

> **[TIP]** Изучите официальную документацию для углубления в тему.`,
  },
  {
    id: "practice_main",
    name: "Практическая работа",
    content: `## Цели практического занятия
Закрепление изученных навыков на реальном практическом кейсе.

### Пошаговый чек-лист выполнения:
- [ ] 1. Инициализировать репозиторий и установить зависимости
- [ ] 2. Реализовать заданные модули и компоненты
- [ ] 3. Написать тесты и проверить корректность работы
- [ ] 4. Сделать коммит и запушить результат в Git

### Критерии оценивания
1. Корректность работы алгоритма (макс. 50 баллов)
2. Чистота и структура кода (макс. 30 баллов)
3. Отсутствие ошибок типизации и линтинга (макс. 20 баллов)

> **[WARNING]** Срок сдачи практической работы — до следующего занятия!`,
  },
  {
    id: "lab_work",
